 ...
 */
public class update_weather extends Fragment {
    ...
    private class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                urlConnection.addRequestProperty("x-api-key", "f71fd9aa302a6d371b382a40a8528e11");
        ...
        protected void onPostExecute(String[] result) {
            ...
            if (result != null) {
                ...
                for(String dayForecastStr : result) {
                    Log.d(LOG_TAG, "Forecast Being Added: "+dayForecastStr);
                    addToList(dayForecastStr);
                }
